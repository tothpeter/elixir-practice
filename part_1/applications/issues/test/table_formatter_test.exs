defmodule TableFormatterTest do
  ...
  def split_with_three_columns,
    do: TF.rotate_and_stringify_list(simple_test_data, headers)

  test "rotate_and_stringify_list" do
  ...
  test "get_column_widths" do
    widths = TF.get_column_widths(split_with_three_columns)
    assert widths == [ 5, 6, 7 ]
  end

  test "correct format string returned" do
    assert TF.get_format([9, 10, 11]) == "~-9s | ~-10s | ~-11s~n"
  end
